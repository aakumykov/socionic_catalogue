...
import ru.aakumykov.me.sociocat.b_tags_list.TagsList_View;
import ru.aakumykov.me.sociocat.c_login_or_register.LoginOrRegister_View;
...
//        boolean showConsoleMessage = BuildConfig.DEBUG && null != consoleMessage;
    ...
    protected void addPreferencesMenuItem() {
        if (AuthSingleton.isLoggedIn())
            inflateMenu(R.menu.preferences);
    }
...
//        MyUtils.showCustomToast(getGlobalContext(), R.string.not_implemented_yet);
//        switch (resultCode) {
//            case RESULT_OK:
