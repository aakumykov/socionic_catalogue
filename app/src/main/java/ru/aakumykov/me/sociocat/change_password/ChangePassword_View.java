...
import ru.aakumykov.me.sociocat.change_password.view_model.ChangePassword_ViewModel;
import ru.aakumykov.me.sociocat.change_password.view_model.ChangePassword_ViewModelFactory;

public class ChangePassword_View extends BaseView implements iChangePassword.iView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ChangePassword_ViewModel viewModel = new ViewModelProvider(this, new ChangePassword_ViewModelFactory())
                .get(ChangePassword_ViewModel.class);

        if (viewModel.hasPresenter()) {
            this.presenter = viewModel.getPresenter();
        } else {
            this.presenter = new ChangePassword_Presenter();
