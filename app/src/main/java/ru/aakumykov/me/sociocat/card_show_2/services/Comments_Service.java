package ru.aakumykov.me.sociocat.card_show_2.services;
...
public class Comments_Service {
    ...
    public void loadComments(int start, int count, iLoadCommentsCallbacks callbacks) {
    ...
    private List<Comment> fetchCommentsFromServer(int start, int count) {
...
//            list.add(new Comment(i));
    ...
    class FetchCommentsCallable implements Callable<List<Comment>> {
        ...
        public FetchCommentsCallable(int start, int count) {
            this.start = start;
            this.count = count;
        }
