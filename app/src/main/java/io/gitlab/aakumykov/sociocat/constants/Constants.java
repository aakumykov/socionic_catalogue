package io.gitlab.aakumykov.sociocat.constants;
...
public final class Constants
{
    ...
    public final static int CARDS_FEED_QUOTE_MAX_LENGTH = 50;
...
//    public final static String NOTIFICATIONS_CHANNEL_BACKUP_SERVICE = "new_comments";
    ...
    public static final int MAX_COMMENTS_AT_ONCE_DELETE_COUNT = 250;
}
