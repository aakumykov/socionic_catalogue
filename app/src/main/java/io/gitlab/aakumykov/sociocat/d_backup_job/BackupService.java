package io.gitlab.aakumykov.sociocat.d_backup_job;
...
import io.gitlab.aakumykov.sociocat.singletons.StorageSingleton;
import io.gitlab.aakumykov.sociocat.singletons.iCardsSingleton;
import io.gitlab.aakumykov.sociocat.singletons.iStorageSingleton;
import io.gitlab.aakumykov.sociocat.utils.DropboxBackuper;
...
public class BackupService extends Service {
    ...
    public static final String BROADCAST_SERVICE_STATUS = "io.gitlab.aakumykov.sociocat.BROADCAST_SERVICE_STATUS";
    public static final String BROADCAST_BACKUP_PROGRESS = "io.gitlab.aakumykov.sociocat.BROADCAST_BACKUP_PROGRESS";
    public static final String BROADCAST_BACKUP_RESULT = "io.gitlab.aakumykov.sociocat.BROADCAST_BACKUP_RESULT";
