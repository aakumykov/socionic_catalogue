...
import io.gitlab.aakumykov.sociocat.user_edit_email.stubs.UserEmailEdit_ViewStub;
    ...
    private void checkEmail() {
        ...
        /*usersSingleton.checkEmailExists(email, new iUsersSingleton.iCheckExistanceCallbacks() {
            ...
            public void onExists() {
                view.setViewState(iUserEditEmail.PageViewState.EMAIL_ERROR, R.string.USER_EDIT_error_email_already_used);
            }
            ...
            public void onCheckFail(String errorMsg) {
                view.setViewState(iUserEditEmail.PageViewState.ERROR, R.string.USER_EDIT_EMAIL_error_checking_email, errorMsg);
            }
        });*/
    }
