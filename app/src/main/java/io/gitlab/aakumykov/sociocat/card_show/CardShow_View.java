...
import io.gitlab.aakumykov.sociocat.card_show.view_model.CardShow_ViewModel;
import io.gitlab.aakumykov.sociocat.card_show.view_model.CardShow_ViewModel_Factory;
...
import io.gitlab.aakumykov.sociocat.utils.comment_form.CommentForm;
import io.gitlab.aakumykov.sociocat.utils.comment_form.iCommentForm;
...
//        recyclerView.smoothScrollToPosition(position);
    ...
    @Override
    public void goBack(@NonNull Card currentCard, @Nullable Card oldCard) {
        Intent intent = new Intent();

        intent.putExtra(Constants.NEW_CARD, currentCard);
