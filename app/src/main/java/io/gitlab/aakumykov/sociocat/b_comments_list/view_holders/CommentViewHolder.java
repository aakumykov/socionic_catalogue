package io.gitlab.aakumykov.sociocat.b_comments_list.view_holders;
...
import io.gitlab.aakumykov.sociocat.a_basic_mvp_list_components.utils.DateUtils;
...
public class CommentViewHolder extends BasicMVPList_DataViewHolder {
    ...
    private void displayCardAuthor(@NonNull Comment comment) {
        ...
        if (TextUtils.isEmpty(userName))
            userName = io.gitlab.aakumykov.sociocat.a_basic_mvp_list_components.utils.TextUtils
